...
public record CopilotConfig(
    ...
    public CopilotConfig {
        ...
        cliHealthcheckSeconds = ConfigDefaults.defaultIfNonPositive(cliHealthcheckSeconds, DEFAULT_CLI_HEALTHCHECK_SECONDS);
        cliAuthcheckSeconds = ConfigDefaults.defaultIfNonPositive(cliAuthcheckSeconds, DEFAULT_CLI_AUTHCHECK_SECONDS);
    }
}
