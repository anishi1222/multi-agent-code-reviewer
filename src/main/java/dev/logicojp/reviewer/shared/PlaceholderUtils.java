...
/// Placeholder replacement helpers for {@code ${key}} style templates.
///
/// This syntax is used for both agent prompt construction and report/summary
/// templates. Only {@code java.*} dependencies are used here.
public final class PlaceholderUtils {
    ...
    /// Replaces {@code ${key}} placeholders in one pass.
