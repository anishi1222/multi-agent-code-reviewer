...
/// Generic retry executor with backoff and circuit-breaker integration.
///
/// The circuit-breaker dependency is expressed via the {@link CircuitBreaker}
/// interface so that this shared-layer class does not depend on any domain
/// implementation.
public final class RetryExecutor<T> {
    ...
    public RetryExecutor(int maxRetries,
        ...
        this.circuitBreaker = circuitBreaker != null ? circuitBreaker : CircuitBreaker.noOp();
    }
