...
class FindingsSummaryFormatterTest {
    ...
    void formatsFindingsInSeverityOrder() {
        var findings = List.of(
            new ReviewFinding("Low issue", "Low", "quality", "quality"),
            new ReviewFinding("Critical issue", "Critical", "security", "security"),
            new ReviewFinding("High issue", "High", "security", "security")
        );
    ...
    void doesNotMergeDifferentCategories() {
        var findings = List.of(
            new ReviewFinding("Same", "High", "security", "security"),
            new ReviewFinding("Same", "High", "performance", "performance")
        );
