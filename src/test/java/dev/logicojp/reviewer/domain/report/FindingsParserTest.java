...
class FindingsParserTest {
    ...
    void extractsFindingsFromHeadingsAndPriorities() {
        ...
        List<ReviewFinding> findings = FindingsParser.extractFindings(content, "agent", "category");
    ...
    void returnsEmptyWhenNoFindingsMarkerExists() {
        List<ReviewFinding> findings = FindingsParser.extractFindings("指摘事項なし", "agent", "category");
