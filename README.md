...
4. `ReviewPassRunner` invokes the Copilot SDK through `RunCopilotSessionPort`, implemented by `infrastructure/copilot`.
5. `GenerateReportUseCase` builds markdown through `WriteReportPort` and `GenerateAiSummaryPort`.
